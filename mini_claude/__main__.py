...
Environment:
  Optional `.env` next to pyproject.toml or in the current working directory
  (OPENAI_API_KEY, OPENAI_BASE_URL, ANTHROPIC_API_KEY, ANTHROPIC_BASE_URL, MINI_CLAUDE_MODEL, …).
...
""")
    ...
    model = args.model or os.environ.get("MINI_CLAUDE_MODEL", "qwen-plus")
    ...
    if os.environ.get("OPENAI_API_KEY") and os.environ.get("OPENAI_BASE_URL"):
        ...
        print_info("Using Anthropic API")
    elif os.environ.get("OPENAI_API_KEY"):
        resolved_api_key = os.environ["OPENAI_API_KEY"]
        resolved_api_base = resolved_api_base or os.environ.get("OPENAI_BASE_URL")
        resolved_use_openai = True
        print_info("Using OpenAI API")
    elif os.environ.get("OPEN_API_KEY"):
        resolved_api_key = os.environ["OPEN_API_KEY"]
        resolved_api_base = resolved_api_base or os.environ.get("OPENAI_BASE_URL")
        resolved_use_openai = True
        print_info("Using Open API")
